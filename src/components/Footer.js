      ...
      <AppBar position="sticky" sx={{ bgcolor: '#EAE7DC' }}> 
        <Toolbar>
          ...
          <IconButton 
            ...
            target="_blank"
          >
            <img src={`${process.env.PUBLIC_URL}/assets/icons/linkedin.png`} alt="LinkedIn Icon" height="24" width="24" />
          </IconButton>
          <IconButton 
            sx={{ 
              color: '#333', 
          ...
          >
            <img src={`${process.env.PUBLIC_URL}/assets/icons/discord.png`} alt="Slack Icon" height="24" width="24" />
          </IconButton>
          <IconButton 
            sx={{ 
              color: '#333',
          ...
          >
            <img src={`${process.env.PUBLIC_URL}/assets/icons/twitter.png`} alt="Twitter Icon" height="24" width="24" />
          </IconButton>
        </Toolbar>
      </AppBar>
    </Box>
